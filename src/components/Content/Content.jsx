...
function Content() {
  ...
  return (
    <section className="md:flex md:flex-row">
      <div className="ml-[70px] mr-[54px] text-bold  flex flex-col items-center bg-gradient-to-b shadow-md-6 from-white/40 rounded-[24px] to-transparent md:w-[20%] ">
        ...
        <div className="flex items-start mb-16 gap-8">
          ...
          <div className="text-26">
            ...
            <p className="text-13 font-semibold md:text-16">Card issue</p>
          </div>
        </div>
      </div>
      <div className="text-13 flex flex-col w-[100%] mt-[90px] font-semibold md:w-[30%] md:mt-0 md:text-16 md:ml-[20%]">
        <div className="check-content">
          ...
          <p>Card reports sent to your iphone every week</p>
        </div>
        <div className="check-content">
          <img src={checkIconMobile} />
        ...
        <div className="check-content">
          <img src={checkIconMobile} />
          <p>Set spending limit and restrictions</p>
        </div>
      </div>
    </section>
  );
